        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 sm:gap-80 items-center">
          ...
          <div className='-mt-16'>
            ...
            <div className="mb-8 relative pt-12 sm:pt-0">
              <span className='absolute right-[10%] sm:-right-[26vw] -top-[1%] sm:-top-12' ><img className='sm:h-14 sm:w-20 h-8 w-12' src="/assets/15.svg" alt="star" /></span>
...
<div className=" relative w-[250px] h-[250px] sm:w-[400px] sm:h-[400px] sm:flex hidden  items-center justify-center sm:ml-12 sm:mt-14  ">
  ...
  {/* Profile Images */}
  <img src="/assets/learners/l.png" alt="Profile" className="absolute top-[-1%] left-1/2 -translate-x-1/2 w-14 h-14 sm:w-20 sm:h-20 rounded-full border-4 border-white shadow-lg object-cover" />
  <img src="/assets/learners/l.png" alt="Profile" className="absolute top-[42%] right-0 -translate-y-1/2 w-14 h-14 sm:w-20 sm:h-20 rounded-full border-4 border-white shadow-lg object-cover" />
  <img src="/assets/learners/l.png" alt="Profile" className="absolute bottom-[12%] right-0 translate-y-1/2 w-14 h-14 sm:w-20 sm:h-20 rounded-full border-4 border-white shadow-lg object-cover" />
  <img src="/assets/learners/l.png" alt="Profile" className="absolute bottom-[12%] left-0 translate-y-1/2 w-14 h-14 sm:w-20 sm:h-20 rounded-full border-4 border-white shadow-lg object-cover" />
  <img src="/assets/learners/l.png" alt="Profile" className="absolute top-[42%] left-0 -translate-y-1/2 w-14 h-14 sm:w-20 sm:h-20 rounded-full border-4 border-white shadow-lg object-cover" />
</div>
