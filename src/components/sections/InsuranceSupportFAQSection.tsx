...
export const InsuranceSupportFAQSection = () => {
  ...
  <div className="w-full lg:w-1/2 bg-white flex items-start py-10 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-12">
        <div className="w-full">
          <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
            Need Assistance?
          </h2>
          {/* highlight-next-line */}
          <p className="text-gray-600 mb-8 text-base lg:text-xl">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1 min-w-0">
                {/* highlight-next-line */}
                <h3 className="font-semibold text-gray-900 mb-1 text-lg lg:text-xl">Email Support</h3>
                <p className="text-gray-500 text-sm mb-2">24-hour response time</p>
                <a href="mailto:insurance@sirtifai.com" className="text-[#FE7642] font-medium break-all text-base">
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1 min-w-0">
                {/* highlight-next-line */}
                <h3 className="font-semibold text-gray-900 mb-1 text-lg lg:text-xl">Live Chat</h3>
  ...
  <div className="w-full lg:w-1/2 bg-[#FEE0D4] flex items-start py-10 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-12">
        <div className="w-full">
          {/* highlight-next-line */}
          ...
          <div className="space-y-8">
            {/* FAQ 1 */}
            <div className="border-b border-[#FDB89B] pb-5">
              {/* highlight-next-line */}
              <h3 className="font-semibold text-gray-900 mb-2 text-lg lg:text-xl">
          ...
          {/* View All FAQs Link */}
          <div className="mt-8">
            <a href="#" className="inline-flex items-center gap-2 text-gray-700 font-medium hover:text-[#FE7642] transition-colors text-base">
              View all FAQs
