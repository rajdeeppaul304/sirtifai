...
export const Faqs = () => {
    ...
    return(
        <section className="w-full flex flex-col justify-center items-center">
            <div className="w-full bg-[#fef7f1] h-[100px] flex justify-between items-center px-6 lg:px-[100px] py-[30px]">
            ...
            <div className="max-w-[1125px] pt-[20px] pb-[50px] px-6 mx-auto flex flex-col gap-[76px] justify-between items-center">
