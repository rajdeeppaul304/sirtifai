  ...
  return (
    <section className="w-full bg-orange-500 py-20">
      <div className="max-w-7xl mx-auto px-6 text-center">
        ...
        {/* Descriptive Text */}
        <p className="sm:text-xl text-sm text-orange-50 mb-12 max-w-3xl mx-auto leading-relaxed">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          ...
          {/* Join SPP Now Button */}
          <button className="px-8 py-4 bg-white text-orange-500 border-2 border-orange-500 rounded-full font-semibold hover:bg-orange-50 transition-colors shadow-md hover:shadow-lg min-w-[200px]">
            Join SPP Now
          </button>
        </div>
      </div>
