...
const LandingFreelancer: React.FC = () => {
  ...
  <div className="max-w-7xl mx-auto px-6 lg:px-10 py-28 grid grid-cols-1 lg:grid-cols-[56%_1fr] gap-6 xl:gap-10 items-center">
        {/* Left content */}
        <div className="order-2 lg:order-1 lg:pl-2 xl:pl-4">
          ...
          <p className="text-gray-700 text-sm sm:text-base md:text-lg max-w-2xl mb-12 leading-relaxed">
          ...
          <div className="flex flex-wrap gap-7 items-center">
            <Button
              variant="secondary"
              size="lg"
              className="relative rounded-full px-9 py-4 bg-[#173447] text-white font-medium shadow-md hover:shadow-lg transition-all overflow-hidden ring-1 ring-[#0E212D] ring-inset after:content-[''] after:absolute after:inset-[4px] after:rounded-full after:border-2 after:border-gray-400 after:pointer-events-none hover:bg-[#142C3C]"
            >
              Watch Stories
            </Button>
            <Button
